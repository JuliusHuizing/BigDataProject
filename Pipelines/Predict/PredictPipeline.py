...
class PredictPipeline:
    def __init__(self, 
                 model_path: str):        
        self.spark = SparkSession.builder.appName("PredictPipeline").getOrCreate()
    ...
    def predict(self, df: DataFrame, results_path: str) -> None:
        ...
        predictions.select("label").write.csv(f'{results_path}', mode="overwrite", header=False)
